...
@st.cache_resource
def process_pdf():
    loader = PyPDFLoader("/RAG/2024_KB_부동산_보고서_최종.pdf")
...
def initialize_vectorstore():
    ...
    faiss_directory = 'RAG/directory/faiss_index'
...
def initialize_chain():
    ...
    def trimming_chat(session_id):
        ...
        chat_history.messages = trimmer.invoke(chat_history.messages)
